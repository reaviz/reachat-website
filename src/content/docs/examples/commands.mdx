...
# Slash Commands
reachat supports `/` slash commands using the same suggestion system as
[mentions](/docs/examples/mentions). Users trigger commands by typing `/`
followed by a command name; commands can either insert text into the editor or
...
<PropsTable typeName="SlashCommandItem" />

### SuggestionConfig Interface

<PropsTable typeName="SuggestionConfig" />
