...
<StoryRenderer path="ChatSuggestions.stories.tsx" name="Basic" fill height={520} storybookKey="components-chatsuggestions--basic" />
...
See [`Suggestion`](/docs/api/models#suggestion) in the API Models reference.
