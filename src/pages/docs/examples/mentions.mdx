...
# Mentions
reachat 2.1 introduces rich text input with @ mentions support powered by [Tiptap v3](https://tiptap.dev/). Users can mention people, teams, or any entity by typing `@` followed by a search query.
